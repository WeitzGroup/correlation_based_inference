% Supp fig 3 - AUC results for standard (pearson) correlation with
    ...
    for s = 1:length(S)
        for n = 1:length(N)
            ...
            if d==1
                ...
                if n==2 && s==1; title('standard Pearson correlation (varying delta)','FontSize',Fs,'FontWeight','normal'); end
...
save_fig(sprintf('%s/suppfig3',save_dir));
